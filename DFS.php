    ...
    public function DFSAction($action){
        switch(strtolower($action)){
            case "download":
                ...
                $pathfile = preg_replace('/'.$slashtype.$slashtype.'/i',$slashtype,$pathfile);
            ...
            case "upload":
                ...
                $path = preg_replace('/'.$slashtype.$slashtype.'/i',$slashtype,$path) . $slashtype;
            ...
            case "edit":
                $slashtype = $this->DFSSlash();
                $this->DFSCurrent($this->Dec(($this->query[0])),$slashtype);
                $pathfile = $this->Dec(($this->query[0])) . $this->Dec(($this->query[1]));
                $pathfile = preg_replace('/'.$slashtype.$slashtype.'/i',$slashtype,$pathfile);
            ...
            case "scand":
                $slashtype = $this->DFSSlash();
                $path = $this->Dec(($this->query[0]));
                $path = $this->Dec($this->DFSDirFilter($path));
                $this->DFSCurrent($path,$slashtype);
